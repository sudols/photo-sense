...
class Person extends amplify_core.Model {
  ...
  const Person._internal({required this.id, required name, faceId, thumbnailS3Key, createdAt, updatedAt})
      : _name = name,
        _faceId = faceId,
  ...
  factory Person({String? id, required String name, String? faceId, String? thumbnailS3Key}) {
  ...
  bool operator ==(Object other) {
    ...
    return other is Person && id == other.id && _name == other._name && _faceId == other._faceId && _thumbnailS3Key == other._thumbnailS3Key;
  }
  ...
  Person copyWith({String? name, String? faceId, String? thumbnailS3Key}) {
    return Person._internal(
      id: id,
      name: name ?? this.name,
